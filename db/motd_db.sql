...
INSERT INTO motds (message) VALUES
    ...
    ('"Dont sit down and wait for the opportunities to come. Get up and make them." — Madam C.J. Walker'),
    ('"Champions keep playing until they get it right." — Billie Jean King'),
    ('"I am lucky that whatever fear I have inside me, my desire to win is always stronger." — Serena Williams'),
    ('"You are never too old to set another goal or to dream a new dream." — C.S. Lewis'),
    ('"It is during our darkest moments that we must focus to see the light." — Aristotle'),
    ('"Believe you can and youre halfway there." — Theodore Roosevelt'),
    ('"Life shrinks or expands in proportion to ones courage." — Anaïs Nin'),
    ...
    ('"If youre having fun, thats when the best memories are built." — Simone Biles'),
    ...
    ('"You define beauty yourself, society doesnt define your beauty." — Lady Gaga'),
    ('"Optimism is a happiness magnet. If you stay positive, good things and good people will be drawn to you." — Mary Lou Retton'),
    ('"You just gotta keep going and fighting for everything, and one day youll get to where you want." — Naomi Osaka'),
    ...
    ('"You cant turn back the clock. But you can wind it up again." — Bonnie Prudden'),
    ('"When you cant find someone to follow, you have to find a way to lead by example." — Roxane Gay'),
    ('"There is no better compass than compassion." — Amanda Gorman'),
    ('"Stand before the people you fear and speak your mind, even if your voice shakes." — Maggie Kuhn'),
    ('"Its a toxic desire to try to be perfect. I realized later in life that the challenge is not to be perfect. Its to be whole." — Jane Fonda'),
